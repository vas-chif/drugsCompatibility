...
public class FunctionPostgreSQL implements IFunctionPostgreSqlPV {
    ...
    public void readTable(String tableName, ArrayList<String> columnList) {
        Statement statement;
        ResultSet rs = null;
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String output = "";
                for (String elment : columnList) {
                    output += rs.getString(columnList.get(count)) + " ";
                    count++;
                }
                System.out.println(output);
    ...
    public ArrayList<String> readColumnDate(String tableName, String column) {
        Statement statement;
        ResultSet rs = null;
        ArrayList<String> extractListOfTable = new ArrayList<>();
    ...
    }//end method deleteTable (String tableName)
